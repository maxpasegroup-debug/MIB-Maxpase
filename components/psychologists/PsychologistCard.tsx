...
export default function PsychologistCard({ psychologist, onBookSession }: PsychologistCardProps) {
  ...
  return (
    <div className="rounded-2xl shadow-lg border border-gray-100 bg-white overflow-hidden flex flex-col transition-all duration-300 hover:shadow-xl hover:scale-[1.01]">
