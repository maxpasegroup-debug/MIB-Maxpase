    ...
    <section className="bg-white rounded-xl shadow-lg p-6 sm:p-8 border border-purple-100">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        {experts.map((expert) => (
          <div
            key={expert.id}
            className="p-4 rounded-lg border border-gray-200 bg-gray-50/50 flex flex-col"
          >
            ...
            <Link
              href={guidanceUrl}
              className="mt-4 inline-flex items-center justify-center rounded-lg bg-purple-600 px-4 py-2.5 text-sm font-medium text-white hover:bg-purple-700"
            >
