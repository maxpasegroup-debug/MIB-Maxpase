...
export default function ProfileCard({ name, email, role }: ProfileCardProps) {
  return (
    <div className="rounded-2xl shadow-lg border border-white/60 bg-white/80 backdrop-blur-md p-6 transition-all duration-300 hover:shadow-xl hover:scale-[1.01]">
