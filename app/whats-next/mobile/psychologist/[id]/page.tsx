...
export default function PsychologistProfilePage() {
  ...
  if (!doc) {
    return (
      <div className="p-6 text-center">
        ...
        <Link href={`${WHATS_NEXT_BASE}/mobile/guidance`} className="text-purple-600 mt-2 inline-block">
          Back to Guidance
        </Link>
      </div>
    );
  ...
  return (
    <div className="px-4 py-6 pb-8">
      <Link
        href={`${WHATS_NEXT_BASE}/mobile/guidance`}
                  ...
                  <div className="flex gap-3 mt-6">
                    ...
                    <motion.button
                      ...
                      onClick={() => {
                        ...
                        router.push(`${WHATS_NEXT_BASE}/mobile/profile`);
                      }}
