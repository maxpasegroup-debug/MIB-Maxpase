...
export default function DashboardPage() {
  ...
  return (
    <div className={sectionSpacing}>
      ...
      <section className={dividerClass + " pt-6"}>
        <h2 className={sectionHeaderClass + " mb-4"}>Exam Coaching</h2>
        <Card>
          <div className="p-6">
            <p className={typography.body + " mb-4"}>AI-powered competitive exam training: diagnostic tests, practice drills, and performance analytics.</p>
            <Link href={`${WHATS_NEXT_BASE}/exam-coaching`}>
              <Button variant="primary">Exam Coaching Arena</Button>
            </Link>
          </div>
        </Card>
      </section>
      ...
      <section className={dividerClass + " pt-6"}>
        ...
        <Card>
          <div className="p-6">
            ...
            <Link href={`${WHATS_NEXT_BASE}/guidance`}>
