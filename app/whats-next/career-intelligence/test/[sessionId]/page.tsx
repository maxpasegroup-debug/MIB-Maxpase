  ...
  if (error && questions.length === 0) {
    return (
      <main className="min-h-screen bg-gray-50 flex flex-col items-center justify-center px-4">
        ...
        <Link href={`${WHATS_NEXT_BASE}/career-intelligence/start`} className="text-purple-600 font-medium">
          Start again
        </Link>
      </main>
    );
  ...
  return (
    <main className="min-h-screen bg-transparent">
      <div className="container max-w-2xl mx-auto px-4 py-8">
        ...
        <Link href={`${WHATS_NEXT_BASE}/career-intelligence`} className="mt-8 inline-block text-sm text-purple-600">
          ← Exit test
        </Link>
      </div>
    </main>
